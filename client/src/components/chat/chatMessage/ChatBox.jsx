...
const ChatBox = () => {
  ...
  return (
    <>
        <header className='bg-green-600 rounded shadow-lg p-2'>
             <div class="flex justify-items-center">
                  <img src={person?.picture} class="rounded-full w-12" alt="Avatar" />
                  <span class="text-xl mx-2 text-white font-medium leading-tight my-2 text">{person?.name}</span>
                  <span className='text-white my-2 block'>Offline</span>
             </div>
        </header>
